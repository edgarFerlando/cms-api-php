...
<div class="content">
	<div class="box">  
		{!! Form::open(array('action' => '\App\Http\Controllers\Backend\ArticleController@store')) !!}
		...
		<div class="box-body">
			...
			<div class="form-group {!! $errors->has('category') ? 'has-error' : '' !!}">
				...
				{!!  Form::select('category', $category_options, '', [ 'class' => 'form-control' ]) !!}
			...
			<div class="form-group {!! $errors->has('source_name') ? 'has-error' : '' !!}">
				...
				{!! 
					Form::text('source_name', Input::old('source_name'), [
						'class'			=> 'form-control',
					]) 
				!!}
			...
			<div class="form-group {!! $errors->has('source_url') ? 'has-error' : '' !!}">
				...
				{!! 
					Form::text('source_url', Input::old('source_url'), [
						'class'			=> 'form-control',
			...
			<div class="form-group {!! $errors->has('body') ? 'has-error' : '' !!}">
				...
				{!! 
					Form::ckeditor('body', Input::old('body'), [
							'class'=>'form-control', 
						]) 
				!!}
