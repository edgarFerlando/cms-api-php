...
return array(
    ...
    */
    'default_format'                        => array(
        'default'               => '<div class="alert alert-:type" id="notification">:message</div>',
        'frontend'               => '<div data-alert class="alert-box :type">:message</div>',
    ),
    ...
    */
    'default_formats'                       => array(
        ...
        'frontend'              => array(
            'error'             => '<div data-alert class="alert-box alert">:message</div>'
        )
    ),
    ...
    */
    'default_types'                         => array(
        ...
        'frontend'               => array('info', 'success', 'warning', 'error'),
    ),
